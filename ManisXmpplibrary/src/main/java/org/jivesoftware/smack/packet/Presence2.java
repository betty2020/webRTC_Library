 ...
 * <ul>
 *      <li>{@link Presence2.Type#available available} -- (Default) indicates the user is available to
 *          receive messages.
 *      <li>{@link Presence2.Type#unavailable unavailable} -- the user is unavailable to receive messages.
 *      <li>{@link Presence2.Type#subscribe subscribe} -- request subscription to recipient's presence.
 *      <li>{@link Presence2.Type#subscribed subscribed} -- grant subscription to sender's presence.
 *      <li>{@link Presence2.Type#unsubscribe unsubscribe} -- request removal of subscription to
 *          sender's presence.
 *      <li>{@link Presence2.Type#unsubscribed unsubscribed} -- grant removal of subscription to
 *          sender's presence.
 *      <li>{@link Presence2.Type#error error} -- the presence packet contains an error message.
 * </ul><p>
 *
 ...
 * @author Matt Tucker
 */
public class Presence2 extends Packet {
     ...
     */
    public Presence2(Type type, String status, int priority, Mode mode) {
        setType(type);
        setStatus(status);
     ...
     * to be the same thing as {@link Presence2.Mode#available}.
     *
     * @param mode the mode.
     */
