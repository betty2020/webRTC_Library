 ...
 * @author Matt Tucker
 */
public class Message2 extends Packet {
     ...
     */
    public Message2(String to, Type type) {
        setTo(to);
        this.type = type;
    }
     ...
     * org.jivesoftware.smack.packet.Message2.Type#normal}.
     *
     ...
     * @return the new {@link org.jivesoftware.smack.packet.Message2.Subject}
     ...
     * @return the new {@link org.jivesoftware.smack.packet.Message2.Body}
    ...
    public String toXML() {
        ...
        Body defaultBody = getMessageBody(null);  
        if (defaultBody != null) {
//        	 buf.append("<body xmlns=\"").append(getXmlns()).append("jid=\"").append("").append("\">");
//        	 buf.append(StringUtils.escapeForXML(defaultBody.message));
//             buf.append("</body>");
