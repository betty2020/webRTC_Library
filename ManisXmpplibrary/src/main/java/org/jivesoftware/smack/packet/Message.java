...
//    public void setBody(String xmlns, String jid, String max, String min,
//    		String videobandwidth, String message, String language) {
//      if (message == null) {
//          removeBody(""); // use empty string because #removeBody(null) is ambiguous
//          return;
//      }
//      addBody(xmlns,jid,max,min,videobandwidth,message,language);
//  }

    public Body addBody(Body messageBody) {
...
//    public Body addBody( String xmlns, String jid, String max, String min,
//    		String videobandwidth, String message, String language) {
//        language = determineLanguage(language);
////        Body messageBody = new Body(language, body);
//       
//        Body messageBody = new Body(xmlns,jid,max,min,videobandwidth,message,language);
//        bodies.add(messageBody);
//        return messageBody;
//    }
...
//            buf.append("<body>").append(StringUtils.escapeForXML(defaultBody.message)).append("</body>");
            ...
            if(newMessageBody!=null){
                if ( newMessageBody.getXmlns()!= null) {
                    buf.append(" xmlns=\"").append(newMessageBody.getXmlns()).append("\"");
                }
                if ( newMessageBody.getJid()!= null) {
                    buf.append(" jid=\"").append(newMessageBody.getJid()).append("\"");
                }
                if ( newMessageBody.getMax()!= null) {
                    buf.append(" max=\"").append(newMessageBody.getMax()).append("\"");
                }
                if ( newMessageBody.getMin()!= null) {
                    buf.append(" min=\"").append(newMessageBody.getMin()).append("\"");
                }
                if ( newMessageBody.getVideobandwidth()!= null) {
                    buf.append(" videobandwidth=\"").append(newMessageBody.getVideobandwidth()).append("\"");
                }
                }
            buf.append(">").append(StringUtils.escapeForXML(defaultBody.message)).append("</body>");
        }
    ...
    public static class Body {
        ...
        public static final String VIDEOBANDWIDTH = "videobandwidth";
        public static final String GATEWAYJID="gateway_jid";
		...
		public void setGatewayJid(String gatewayJid) {
...
//		public Body(String xmlns, String jid, String max, String min,
//				String videobandwidth, String message, String language) {
//			super();
//			this.xmlns = xmlns;
//			this.jid = jid;
