...
//                    }
                    ...
                    Message.Body body1 = new Message.Body(xmlLang,"");
                    body1.setXmlns(parser.getNamespace());
                    body1.setJid(getAttribute(parser, Message.Body.JID));
                    body1.setMax(getAttribute(parser, Message.Body.MAX));
                    body1.setMin(getAttribute(parser, Message.Body.MIN));
                    body1.setVideobandwidth(getAttribute(parser, Message.Body.VIDEOBANDWIDTH));
                    body1.setGatewayJid(getAttribute(parser, Message.Body.GATEWAYJID));

                    String body = parseContent(parser);
                    body1.setMessage(body);
                    
//                    message.removeBody(xmlLang);
...
//                	//lp add
////                	XPresenceExtension xpe=new XPresenceExtension();
//                }
                // Otherwise, it must be a packet extension.
                else {
