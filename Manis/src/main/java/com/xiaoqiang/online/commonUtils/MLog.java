...
/**
 * Created by xiaoqiang on 2017/5/3 14:33
 * 2017 to: 邮箱：sin2t@sina.com
 * androidApp  ##  模仿logger，创建自己的日志操作类
 */
public class MLog {
    ...
    public static void llog(int type, String tagStr, Object obj) {
        ...
        stringBuilder.append("[所在位置:(").append(className).append(":").append(lineNumber).append(")所在函数:").append(methodName).append(" ] ");
