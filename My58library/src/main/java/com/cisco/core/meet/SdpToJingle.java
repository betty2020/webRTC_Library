...
public class SdpToJingle {
	...
	public static CandidatePacketExtension parseCandidate(String c) {
		...
		System.out.println("linepng,jky,c=" + c);
...
//		sb.append(NL);
		...
		System.out.println("linepng,jky,priority=" + priority);
...
//		String a="a=fmtp:126 level-asymmetry-allowed=1;packetization-mode=1;profile-level-id=42e01f;";
//
