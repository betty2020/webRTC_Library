...
public class JingleToSdpH264
{
                                        ...
                                        StringBuilder sb)
    {
        ...
        sb.append("c=IN IP4 0.0.0.0").append(NL);//linpeng add  h264
...
//            for (ParameterPacketExtension ppe : pt.getParameters()) {
//                getid=""+pt.getID();
//                fmtp+=ppe.getName()+"="+ppe.getValue()+";";
//            }
//            sb.append("a=fmtp:").append(getid).append(' ').append(fmtp).append(NL);
