...
class WebRtcAudioEffects {
  ...
  private boolean effectTypeIsVoIP(UUID type) {
    return !WebRtcAudioUtils.runningOnJellyBeanMR2OrHigher()?false:AudioEffect.EFFECT_TYPE_AEC.equals(type) && isAcousticEchoCancelerSupported() || AudioEffect.EFFECT_TYPE_NS.equals(type) && isNoiseSuppressorSupported();
  }
