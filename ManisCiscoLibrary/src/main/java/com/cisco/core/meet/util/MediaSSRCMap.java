...
public class MediaSSRCMap
{
    ...
    public Map<String, List<SourcePacketExtension>> getSsrcs() {
        return ssrcs;
    }

    public void setSsrcs(Map<String, List<SourcePacketExtension>> ssrcs) {
        this.ssrcs = ssrcs;
    }
...
//            Log.i("", "SOURCE ADD put media=: " +media+"=ssrcPe="+ssrcPe);
//            for (int i=0; i<ssrcPe.size();i++){
//                ssrcPe.get(i).getSSRC();
//            }
        }
