...
public interface AppRTCClient {
   ...
   */
  void connectToRoom(RoomConnectionParameters connectionParameters,CiscoApiInterface.UpdateUIEvents updateEvents);
  ...
  interface SignalingEvents {
     ...
     */
//    void onConnectedToRoom(final SignalingParameters params);//原来
...
//     */
//    void onRemoteIceCandidatesRemoved(final IceCandidate[] candidates);//�°���ӵ�
//
//    /**
